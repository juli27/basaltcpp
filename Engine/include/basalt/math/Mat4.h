...
public:
  ...
  constexpr Mat4& operator*=(float f);
  ...
  //static Mat4 RotationAxis(const tbVector3& axis, float rad);
...
constexpr float Mat4::Det() const {
...
constexpr Mat4& Mat4::operator*=(float f) {
...
constexpr Mat4 operator*(float f, const Mat4& m) {
  return Mat4(
    m.m11 * f, m.m12 * f, m.m13 * f, m.m14 * f,
    m.m21 * f, m.m22 * f, m.m23 * f, m.m24 * f,
    m.m31 * f, m.m32 * f, m.m33 * f, m.m34 * f,
