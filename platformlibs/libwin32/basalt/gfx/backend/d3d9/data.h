...
struct D3D9FixedVertexShader {
  static auto from(const FixedVertexShaderCreateInfo*) -> D3D9FixedVertexShader;
...
struct D3D9Fog {
  static auto from(const FixedVertexShaderCreateInfo*,
                   const FixedFragmentShaderCreateInfo*) -> D3D9Fog;
...
struct D3D9TexStage {
  static auto from(const FixedVertexShaderCreateInfo*,
                   const FixedFragmentShaderCreateInfo*)
